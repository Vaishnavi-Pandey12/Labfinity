...
interface BoylePoint { volume: number; pressure: number; pv: number; }
interface CharlesPoint { temperature: number; volume: number; ratio: number; }
interface CarnotPoint { hotTemp: number; coldTemp: number; efficiency: number; }
